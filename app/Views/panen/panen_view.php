...
echo view('_partials/header'); ?>
        ...
        <div class="container-fluid">
            <div class="row mx-2 mb-3">
                <div class="mb-3">
                    <h3 class="head-title mb-2">Panen</h3>
                    <button type="button" class="tb-button py-2 px-4 my-2" data-bs-toggle="modal" data-bs-target="#addPanen">
                        <span><i class="fa-solid fa-plus me-2"></i></span>Panen Baru
                    </button>
                </div>
                               ...
                               <?php foreach ($panen as $key => $row) {  ?>
                                    <tr class="mt-1 mb-1">
                                        ...
                                        <td class="d-flex text-center">
                                            <a class="btn btn-edit me-2" data-bs-toggle="modal" data-bs-target="#editPanen<?php echo $row['id']; ?>"><i class="fa-solid fa-edit"></i></a>
                                            <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusPanen<?php echo $row['id']; ?>"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>
                                
                            
                                <div class="modal fade" id="editPanen<?php echo $row['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content" style="border: none; border-radius: 20px;">
                                            ...
                                            <div class="modal-body">
                                                <form id="menuForm" method="POST" action="<?php echo base_url('panen/edit/' . $row['id']); ?>">
                                                    <div class="">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="jumlah" class="form-label">Jumlah Hasil Panen</label>
                                                        <div class="d-flex">
                                                            <input type="number" name="jumlah" class="form-control" value="<?php echo $row['jumlah']; ?>" id="jumlah" required>
                                ...
                                <div class="modal fade" id="hapusPanen<?php echo $row['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" enctype="multipart/form-data">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content" style="border: none; border-radius: 20px;">
                                            <div class="modal-header justify-content-center">
                                                <h5 class="d-block modal-title">Hapus Panen</h5>
                                            </div>
                                                                        
                                            <div class="modal-body">
                                                <form id="menuForm" method="POST" action="<?php echo base_url('panen/delete/' . $row['id']); ?>">
                                                    <div class="">
        ...
        <div class="modal fade" id="addPanen" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="border: none; border-radius: 20px;">
                    <div class="modal-header">
                        <h5 class="modal-title">Panen Baru</h5>
                    </div>
                                                
                    <div class="modal-body">
                        <form id="menuForm" method="POST" action="<?php echo base_url('panen/simpan'); ?>">
                            <div class="">
                                <input type="text" name="id" hidden>
                            </div>
        ...
        <nav class="navbar navbar-expand-lg fixed-bottom">
            <div class="container-fluid justify-content-center mb-3">
                <ul class="navbar-nav navbar-bottom d-contents">
                    ...
                    <li class="nav-item text-center mx-4">
                        <a class="nav-link d-grid py-0 active" href="<?php echo base_url('panen'); ?>"><i class="fa-solid fa-boxes-stacked mb-2"></i>Panen</a>
                    </li>
                    <li class="nav-item text-center mx-4">
